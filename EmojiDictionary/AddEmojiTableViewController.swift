...
class AddEmojiTableViewController: UITableViewController {
    ...
    func updateDoneButtonState() {
        ...
        doneButton.isEnabled = !symbolText.isEmpty && !nameText.isEmpty && !descriptionText.isEmpty && !usageText.isEmpty && containsSingleEmoji(symbolTextField)
    }
    ...
    required init?(coder: NSCoder, emoji: Emoji?) {
        self.emoji = emoji
